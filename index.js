...
let allAnimals = farmAnimals.split(" ").filter((name)=>name!=='horse');
let [bessie, dolly, babe,little]=allAnimals;
// 3. Little the chicken had to go back to the coop, so now we're left with three. Let's use color variables of blackAndWhite, black, and pink.
let [blackAndWhite, black, pink] = allAnimals.filter((name)=>name!=='chicken');
// Arrays
